...
public class CartsController : BaseController
{
    ...
    public async Task<IActionResult> CreateCart([FromBody] CreateCartRequest request, CancellationToken cancellationToken)
    {
        ...
        return Created(string.Empty, new ApiResponseWithData<CreateCartResponse>
        {
            ...
            Content = _mapper.Map<CreateCartResponse>(response)
        });
    }
    ...
    public async Task<IActionResult> GetCart([FromRoute] Guid id, CancellationToken cancellationToken)
    {
        ...
        return Ok(new ApiResponseWithData<GetCartResponse>
        {
            ...
            Content = _mapper.Map<GetCartResponse>(response)
        });
    }
    ...
    public async Task<IActionResult> UpdateCart([FromRoute] Guid id, [FromBody] UpdateCartRequest request, CancellationToken cancellationToken)
    {
        ...
        return Ok(new ApiResponseWithData<UpdateCartResponse>
        {
            ...
            Content = _mapper.Map<UpdateCartResponse>(response)
        });
    }
    ...
    /// </summary>
    /// <param name="cancellationToken">Cancellation token</param>
    /// <returns>List of carts containing carts details if found</returns>
    [HttpGet]
    [ProducesResponseType(typeof(ApiResponseWithData<ListCartsResponse>), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(ApiResponse), StatusCodes.Status400BadRequest)]
    [ProducesResponseType(typeof(ApiResponse), StatusCodes.Status404NotFound)]
    [HttpGet]
    public async Task<ApiResponseWithData<ListCartsResponse>> ListCarts(
        ...
        [FromQuery(Name = "_order")] string? order = null )
    {
        ...
        var response = new ApiResponseWithData<ListCartsResponse>
        {
            Success = true,
            Message = "User retrieved successfully",
            Content = _mapper.Map<ListCartsResponse>(result)
        };
        return response;
    }
